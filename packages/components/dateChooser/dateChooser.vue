<template>
	<div :class="['mvi-date-chooser',block?'mvi-date-chooser-block':'']" :data-id="`mvi-date-chooser-${uid}`">
		<div class="mvi-date-chooser-target" :data-id="`mvi-date-chooser-target-${uid}`" ref="target" @click="clickCalendar"><slot></slot></div>
		<m-layer
				...
				<div class="mvi-date-chooser-header">
					<div class="mvi-date-chooser-header-left">
						<span
							...
							:disabled="prevYearDisabled || null"
						>
					...
					<div class="mvi-date-chooser-header-right">
						...
						<span
							...
							:disabled="nextYearDisabled || null"
						>
