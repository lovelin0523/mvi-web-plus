<template>
	<label class="mvi-checkbox" :disabled="disabled || null">
		<span v-if="labelPlacement=='left' && label" :disabled="disabled || null" class="mvi-checkbox-label"
			:data-placement="labelPlacement" v-text="label" :style="labelStyle"></span>
		<input @change="change" :value="value" :disabled="disabled || null" :checked="check" type="checkbox"
			:name="name" />
		<span :disabled="disabled || null" :class="['mvi-checkbox-item',check?'mvi-checkbox-item-check':'']"
			:style="checkboxStyle">
			<m-icon :disabled="disabled || null" :color="iconColor" :size="iconSize" :type="iconType"
				:class="['mvi-checkbox-icon',check?'mvi-checkbox-icon-check':'']" />
		</span>
		<span v-if="labelPlacement=='right' && label" :disabled="disabled || null" class="mvi-checkbox-label"
			:data-placement="labelPlacement" v-text="label" :style="labelStyle"></span>
	</label>
</template>
